...
"""autogenerated by genpy from mushr_mujoco_ros/BodyState.msg. Do not edit."""
import sys
...
class BodyState(genpy.Message):
  _md5sum = "b8f1fd9bf43972d4a95f5b5f903bf644"
  _type = "mushr_mujoco_ros/BodyState"
...
float64 y
float64 z"""
  __slots__ = ['name','ctrl_steering_angle','ctrl_velocity','pose','imu','velocity']
  _slot_types = ['string','float64','float64','geometry_msgs/Pose','sensor_msgs/Imu','geometry_msgs/Vector3']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       name,ctrl_steering_angle,ctrl_velocity,pose,imu,velocity
    ...
    if args or kwds:
      ...
      if self.name is None:
        self.name = ''
      if self.ctrl_steering_angle is None:
        self.ctrl_steering_angle = 0.
      if self.ctrl_velocity is None:
        self.ctrl_velocity = 0.
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_get_struct_9d3I().pack(_x.ctrl_steering_angle, _x.ctrl_velocity, _x.pose.position.x, _x.pose.position.y, _x.pose.position.z, _x.pose.orientation.x, _x.pose.orientation.y, _x.pose.orientation.z, _x.pose.orientation.w, _x.imu.header.seq, _x.imu.header.stamp.secs, _x.imu.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.ctrl_steering_angle, _x.ctrl_velocity, _x.pose.position.x, _x.pose.position.y, _x.pose.position.z, _x.pose.orientation.x, _x.pose.orientation.y, _x.pose.orientation.z, _x.pose.orientation.w, _x.imu.header.seq, _x.imu.header.stamp.secs, _x.imu.header.stamp.nsecs,) = _get_struct_9d3I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
